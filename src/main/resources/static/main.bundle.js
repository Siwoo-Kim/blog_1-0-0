...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__tester_tester_module__ = __webpack_require__("./src/app/tester/tester.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__topic_topic_module__ = __webpack_require__("./src/app/topic/topic.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__service_service_module__ = __webpack_require__("./src/app/service/service.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["K" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__service_service_module__["a" /* ServiceModule */],
                __WEBPACK_IMPORTED_MODULE_9__category_category_module__["a" /* CategoryModule */],
                __WEBPACK_IMPORTED_MODULE_10__topic_topic_module__["a" /* TopicModule */],
                __WEBPACK_IMPORTED_MODULE_6__tester_tester_module__["a" /* TesterModule */],
            ],
            providers: [
                { provide: __WEBPACK_IMPORTED_MODULE_8__app_tokens__["c" /* BACKEND_URL_TOKEN */], useValue: __WEBPACK_IMPORTED_MODULE_8__app_tokens__["d" /* DEV_ENV_BACKEND_URL */] },
                { provide: __WEBPACK_IMPORTED_MODULE_8__app_tokens__["b" /* ADMIN_GITHUB_TOKEN */], useValue: __WEBPACK_IMPORTED_MODULE_8__app_tokens__["a" /* ADMIN_GITHUB_NAME */] }
            ],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return DEV_ENV_BACKEND_URL; });
/* unused harmony export PROD_ENV_BACKEND_URL */
...
var CategoryBootstrapComponent = /** @class */ (function () {
    function CategoryBootstrapComponent(categoryRepository) {
        ...
        this.categoryRepository
            .allShorts()
            .subscribe(function (_shortCategories) { return _this.panelLists = __WEBPACK_IMPORTED_MODULE_2__model_short_category_model__["a" /* ShortCategory */].toPanelList(_shortCategories); });
    }
...
/***/ "./src/app/model/short-topic.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ShortTopic; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_panel_panel_list_model__ = __webpack_require__("./src/app/shared/panel/panel-list.model.ts");

var ShortTopic = /** @class */ (function () {
    function ShortTopic(id, name) {
        this.id = id;
        this.name = name;
    }
    ShortTopic.toPanelList = function (shortTopics) {
        var panelists = [];
        shortTopics.forEach(function (_shortTopic) {
            var panelListItems = [];
            panelists.push(new __WEBPACK_IMPORTED_MODULE_0__shared_panel_panel_list_model__["a" /* PanelList */](_shortTopic.name, '', []));
        });
        return panelists;
    };
    return ShortTopic;
...
var CategoryRepository = /** @class */ (function () {
    ...
    CategoryRepository.prototype.allNames = function () {
        return this.dataSource
            ...
            .set(__WEBPACK_IMPORTED_MODULE_3__param_rule_model__["d" /* REQUEST_NAME */].key, __WEBPACK_IMPORTED_MODULE_3__param_rule_model__["d" /* REQUEST_NAME */].value));
    };
    CategoryRepository.prototype.allShorts = function () {
        return this.dataSource.get(this.categoryUrl, new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["c" /* HttpParams */]()
            .set(__WEBPACK_IMPORTED_MODULE_3__param_rule_model__["e" /* REQUEST_SHORT */].key, __WEBPACK_IMPORTED_MODULE_3__param_rule_model__["e" /* REQUEST_SHORT */].value));
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return REQUEST_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return REQUEST_SHORT; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__topic_repository_service__ = __webpack_require__("./src/app/service/topic-repository.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__language_repository_service__ = __webpack_require__("./src/app/service/language-repository.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__youtube_service__ = __webpack_require__("./src/app/service/youtube.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__token_repository_service__ = __webpack_require__("./src/app/service/token-repository.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__github_repository_service__ = __webpack_require__("./src/app/service/github-repository.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ServiceModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__youtube_service__["a" /* YoutubeService */],
                __WEBPACK_IMPORTED_MODULE_8__token_repository_service__["a" /* TokenRepository */],
                __WEBPACK_IMPORTED_MODULE_9__github_repository_service__["a" /* GitHubService */],
                /*repository*/
                __WEBPACK_IMPORTED_MODULE_4__category_repository_service__["a" /* CategoryRepository */],
                __WEBPACK_IMPORTED_MODULE_5__topic_repository_service__["a" /* TopicRepository */],
                __WEBPACK_IMPORTED_MODULE_6__language_repository_service__["a" /* LanguageRepository */],
            ],
        })
    ], ServiceModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__tester_component__ = __webpack_require__("./src/app/tester/tester.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__tester_reddit_main_reddit_reddit_component__ = __webpack_require__("./src/app/tester/tester/reddit-main/reddit/reddit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tester_reddit_main_article_article_component__ = __webpack_require__("./src/app/tester/tester/reddit-main/article/article.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tester_reddit_main_reddit_main_component__ = __webpack_require__("./src/app/tester/tester/reddit-main/reddit-main.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tester_inventory_main_inventory_main_component__ = __webpack_require__("./src/app/tester/tester/inventory-main/inventory-main.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tester_inventory_main_category_short_list_category_short_list_component__ = __webpack_require__("./src/app/tester/tester/inventory-main/category-short-list/category-short-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__tester_inventory_main_category_short_list_category_short_row_category_short_row_component__ = __webpack_require__("./src/app/tester/tester/inventory-main/category-short-list/category-short-row/category-short-row.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__tester_inventory_main_category_short_list_category_short_row_category_img_category_img_component__ = __webpack_require__("./src/app/tester/tester/inventory-main/category-short-list/category-short-row/category-img/category-img.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__tester_inventory_main_category_short_list_category_short_row_category_details_category_details_component__ = __webpack_require__("./src/app/tester/tester/inventory-main/category-short-list/category-short-row/category-details/category-details.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__tester_echo_echo_component__ = __webpack_require__("./src/app/tester/tester/echo/echo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__form_form_component__ = __webpack_require__("./src/app/tester/form/form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__form_category_form_category_form_component__ = __webpack_require__("./src/app/tester/form/category-form/category-form.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__youtube_youtube_component__ = __webpack_require__("./src/app/tester/youtube/youtube.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__youtube_youtube_search_youtube_search_component__ = __webpack_require__("./src/app/tester/youtube/youtube-search/youtube-search.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__youtube_youtube_search_service__ = __webpack_require__("./src/app/tester/youtube/youtube-search.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__youtube_youtube_card_youtube_card_component__ = __webpack_require__("./src/app/tester/youtube/youtube-card/youtube-card.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'tester', component: __WEBPACK_IMPORTED_MODULE_5__tester_component__["a" /* TesterComponent */],
        children: [
            { path: 'reddit', component: __WEBPACK_IMPORTED_MODULE_8__tester_reddit_main_reddit_main_component__["a" /* RedditMainComponent */] },
            { path: 'inventory', component: __WEBPACK_IMPORTED_MODULE_9__tester_inventory_main_inventory_main_component__["a" /* InventoryMainComponent */] },
            { path: 'echo', component: __WEBPACK_IMPORTED_MODULE_9__tester_inventory_main_inventory_main_component__["a" /* InventoryMainComponent */] },
            { path: 'form', component: __WEBPACK_IMPORTED_MODULE_15__form_form_component__["a" /* FormComponent */] },
            { path: 'youtube', component: __WEBPACK_IMPORTED_MODULE_18__youtube_youtube_component__["a" /* YoutubeComponent */] },
        ]
    },
];
var TesterModule = /** @class */ (function () {
    ...
    TesterModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            providers: [
                __WEBPACK_IMPORTED_MODULE_20__youtube_youtube_search_service__["a" /* YOUTUBE_API_TOKENS */],
                __WEBPACK_IMPORTED_MODULE_20__youtube_youtube_search_service__["b" /* YoutubeSearchService */]
            ],
            imports: [
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_5__tester_component__["a" /* TesterComponent */],
                __WEBPACK_IMPORTED_MODULE_6__tester_reddit_main_reddit_reddit_component__["a" /* RedditComponent */],
                __WEBPACK_IMPORTED_MODULE_7__tester_reddit_main_article_article_component__["a" /* ArticleComponent */],
                __WEBPACK_IMPORTED_MODULE_8__tester_reddit_main_reddit_main_component__["a" /* RedditMainComponent */],
                __WEBPACK_IMPORTED_MODULE_9__tester_inventory_main_inventory_main_component__["a" /* InventoryMainComponent */],
                __WEBPACK_IMPORTED_MODULE_10__tester_inventory_main_category_short_list_category_short_list_component__["a" /* CategoryShortListComponent */],
                __WEBPACK_IMPORTED_MODULE_11__tester_inventory_main_category_short_list_category_short_row_category_short_row_component__["a" /* CategoryShortRowComponent */],
                __WEBPACK_IMPORTED_MODULE_12__tester_inventory_main_category_short_list_category_short_row_category_img_category_img_component__["a" /* CategoryImgComponent */],
                __WEBPACK_IMPORTED_MODULE_13__tester_inventory_main_category_short_list_category_short_row_category_details_category_details_component__["a" /* CategoryDetailsComponent */],
                __WEBPACK_IMPORTED_MODULE_14__tester_echo_echo_component__["a" /* EchoComponent */],
                __WEBPACK_IMPORTED_MODULE_15__form_form_component__["a" /* FormComponent */],
                __WEBPACK_IMPORTED_MODULE_16__form_category_form_category_form_component__["a" /* CategoryFormComponent */],
                __WEBPACK_IMPORTED_MODULE_18__youtube_youtube_component__["a" /* YoutubeComponent */],
                __WEBPACK_IMPORTED_MODULE_19__youtube_youtube_search_youtube_search_component__["a" /* YoutubeSearchComponent */],
                __WEBPACK_IMPORTED_MODULE_21__youtube_youtube_card_youtube_card_component__["a" /* YoutubeCardComponent */],
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_3__angular_router__["d" /* RouterModule */]
            ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operators__ = __webpack_require__("./node_modules/rxjs/_esm5/operators.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service_category_repository_service__ = __webpack_require__("./src/app/service/category-repository.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_short_topic_model__ = __webpack_require__("./src/app/model/short-topic.model.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TopicBootstrapComponent = /** @class */ (function () {
    function TopicBootstrapComponent(categoryRepository, route) {
        ...
        this.categoryRepository = categoryRepository;
        this.route = route;
        this.route.params.pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["map"])(function (params) { return params['categoryName']; }), Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["switchMap"])(function (categoryName) { return _this.categoryRepository.allShortByCategoryName(categoryName); })).subscribe(function (_shortCategory) {
            _this.panelLists = [];
            _this.panelLists = __WEBPACK_IMPORTED_MODULE_4__model_short_topic_model__["a" /* ShortTopic */].toPanelList(_shortCategory.topics);
        });
    }
    ...
    TopicBootstrapComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__service_category_repository_service__["a" /* CategoryRepository */],
